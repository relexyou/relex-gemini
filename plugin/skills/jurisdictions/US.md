...
> Gemini-facing orientation; **complements** the backend's agent-facing `US`
...
Anthropic `Gemini-for-legal` (litigation-legal for demands/claim-charts/dockets;
ip-legal; privacy-legal) for generic US drafting playbooks; `master-Gemini-for-legal`
