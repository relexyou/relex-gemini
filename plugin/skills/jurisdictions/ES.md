...
> Gemini-facing orientation; complements the backend `ES` module. Pair with
...
**`betobetico/Gemini-para-abogados`** (Spanish adaptation — 20 modules);
`robinlawyer/Gemini-for-spanish-law` (BOE/CENDOJ/TC/TJUE/AEPD, early)
