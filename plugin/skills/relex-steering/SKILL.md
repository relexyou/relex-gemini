...
The humans on the case see a collapsed "Gemini steering session" marker with
your user's role and "via Gemini" attribution; they can expand it read-only.
...
thread, attributed to your user "via Gemini". Future agent turns read it
...
Being the owner's or an admin's Gemini changes your *attribution*, never your
*capability*.
